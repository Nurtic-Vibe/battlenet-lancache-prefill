...
2.  Download the latest version for Windows.  The filename should look like `BattleNetPrefill-X.Y.Z-win-x64.zip`.
3.  Unzip to a directory of your choice.  This can be anywhere on your system.

## Optional Windows Setup

Configuring your terminal to use Unicode will result in a much nicer experience with **BattleNetPrefill**, for much nicer looking UI output.
